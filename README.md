...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/twilight-bird-86f1#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/twilight-bird-86f1
```

A live public deployment of this template is available at [https://twilight-bird-86f1.templates.workers.dev](https://twilight-bird-86f1.templates.workers.dev)
